...
proc create_hier_cell_ctrl { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_ctrl() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_accelerator { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_accelerator() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ctrl_M02_AXI [get_bd_intf_pins ctrl/M02_AXI] [get_bd_intf_pins zed_audio_ctrl_0/S_AXI]
  ...
  connect_bd_net -net ctrl_peripheral_aresetn [get_bd_pins ctrl/peripheral_aresetn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  ...
  connect_bd_net -net processing_system7_0_fclk_clk0 [get_bd_pins accelerator/aclk] [get_bd_pins ctrl/ctrl_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins zed_audio_ctrl_0/S_AXI_ACLK]
