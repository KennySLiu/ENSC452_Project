...
HD_PWD='C:/Users/awa159/Downloads/IP_to_import/gain_controller_ip/gain_controller_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gain_controller_stream.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gain_controller_stream.tcl
