...
HD_PWD='C:/Users/awa159/Downloads/peqstr/peqstr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eq_streaming.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eq_streaming.tcl
